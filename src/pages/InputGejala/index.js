  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Bagaimana Kondisimu Saat Ini?</Text>
        <Text style={styles.desc}>Silahkan Isi</Text>
        ...
        <View style={styles.form}>
          ...
          <Input
            ...
            label="Suhu Badan (Opsional)"
          />
          <Gap height={15} />
          <Input
            onChangeText={(text) => setOksigen(text)}
            label="Tingkat Oksigen  (Opsional)"
          />
          <Gap height={15} />
          <Button title="Continue" onPress={() => simpanGejala()} />
          <Gap height={30} />
          <View style={styles.border}></View>
          <Gap height={15} />
          <Text>
            Jika anda tidak mempunyai alat pengukur suhu dan/atau oksigen,
            silahkan isi form Suhu Badan dan/atau Tingkat Oksigen dengan "Tidak
            Ada"{' '}
          </Text>
        </View>
      </View>
